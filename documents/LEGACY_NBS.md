...
└── legacy_notebooks/
    ...
    │   │
    │   └── e2e-qs-net_v3.0.ipynb       # class-weighted 200 train CICIoT2023                    ## 30 eps, 64 b_sz
    │
    └── legacy_q8_pipeline/     # day (11-14, 16-19, 22, 24) deliverables ## LEGACY NOTEBOOKS
        ...
        │
        ├── 12.fgsm-pgd-dummy.ipynb                     # class-weighted 200 train CICIoT2023    ## 10 eps, 32 b_sz
        ├── 12.fgsm-pgd-kaggle.ipynb                    # class-weighted train CICIoT2023        ## 10 eps, 128 b_sz ## T/O
        │
        ├── 13.tune-lambdas-demo.ipynb                  # DEMO: Lambdas Tuning
        ├── ./                                          # REAL: Lambdas Tuning
        │   13.tune-lambdas-bot-iot.ipynb               ## class-weighted 0.5% train BoT-IoT     ## 10 eps, 64 b_sz
        │   13.tune-lambdas-ciciot2023.ipynb            ## class-weighted 0.5% train CICIoT2023  ## 10 eps, 64 b_sz
        │   13.tune-lambdas-unsw-nb15.ipynb             ## class-weighted 0.5% train UNSW-NB15   ## 10 eps, 32 b_sz
        │
        ...
        │
        ├── ./                                          # REAL: MAQT Training
        │   16.estimate-lipschitz_bot-iot.ipynb         ## capped(700), ~2800 train BoT-IoT      ## 10 eps, 64 b_sz
        │   16.estimate-lipschitz_ciciot2023.ipynb      ## capped(100), ~2800 train CICIoT2023   ## 10 eps, 64 b_sz
        │   16.estimate-lipschitz_unsw-nb15.ipynb       ## capped(400), ~2800 train UNSW-NB15    ## 10 eps, 64 b_sz
        │
