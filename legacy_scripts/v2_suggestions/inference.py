...
def predict_labels(
    X, y, theta, classifier_head, forward_circuit, device, batch_size=64
):
...
def estimate_lipschitz(
    X, theta, forward_circuit, n_probe=30, delta=0.05, device=None, batch_size=64
):
    """
...
def predict_batch(X, theta, prototypes, q, forward_circuit, **infer_kwargs):
    ...
    labels, radii, scores, _ = qsnet_infer_batch(
